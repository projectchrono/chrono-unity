...
public class ChBodyAuxRef : ChBody {
  ...
  public ChBodyAuxRef() : this(ChronoEngine_csharpPINVOKE.new_ChBodyAuxRef__SWIG_0(), true) {
    if (ChronoEngine_csharpPINVOKE.SWIGPendingException.Pending) throw ChronoEngine_csharpPINVOKE.SWIGPendingException.Retrieve();
  }

  public ChBodyAuxRef(ChCollisionModel new_coll_model) : this(ChronoEngine_csharpPINVOKE.new_ChBodyAuxRef__SWIG_1(ChCollisionModel.getCPtr(new_coll_model)), true) {
    if (ChronoEngine_csharpPINVOKE.SWIGPendingException.Pending) throw ChronoEngine_csharpPINVOKE.SWIGPendingException.Retrieve();
  }

  public ChBodyAuxRef(ChBodyAuxRef other) : this(ChronoEngine_csharpPINVOKE.new_ChBodyAuxRef__SWIG_2(ChBodyAuxRef.getCPtr(other)), true) {
    if (ChronoEngine_csharpPINVOKE.SWIGPendingException.Pending) throw ChronoEngine_csharpPINVOKE.SWIGPendingException.Retrieve();
  }
