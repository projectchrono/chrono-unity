...
public class M113_TrackAssemblySinglePin : ChTrackAssemblySinglePin {
  ...
  public M113_TrackAssemblySinglePin(VehicleSide side, BrakeType brake_type, bool add_RSDA) : this(vehiclePINVOKE.new_M113_TrackAssemblySinglePin((int)side, (int)brake_type, add_RSDA), true) {
