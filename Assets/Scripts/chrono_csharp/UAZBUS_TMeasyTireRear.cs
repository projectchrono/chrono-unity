...
public class UAZBUS_TMeasyTireRear : ChTMeasyTire {
  ...
  public override double GetMass() {
    double ret = vehiclePINVOKE.UAZBUS_TMeasyTireRear_GetMass(swigCPtr);
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override ChVectorD GetInertia() {
    ChVectorD ret = new ChVectorD(vehiclePINVOKE.UAZBUS_TMeasyTireRear_GetInertia(swigCPtr), true);
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
