...
public class Pac02Tire : ChPac02Tire {
  ...
  public virtual double GetNormalStiffnessForce(double depth) {
    double ret = vehiclePINVOKE.Pac02Tire_GetNormalStiffnessForce(swigCPtr, depth);
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual double GetNormalDampingForce(double depth, double velocity) {
    double ret = vehiclePINVOKE.Pac02Tire_GetNormalDampingForce(swigCPtr, depth, velocity);
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public virtual void SetPac02Params() {
    vehiclePINVOKE.Pac02Tire_SetPac02Params(swigCPtr);
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
  }
