...
public class ChTriangle : ChGeometry {
  ...
  public static double PointTriangleDistance(ChVectorD B, ChVectorD A1, ChVectorD A2, ChVectorD A3, SWIGTYPE_p_double mu, SWIGTYPE_p_double mv, SWIGTYPE_p_bool is_into, ChVectorD Bprojected) {
    double ret = ChronoEngine_csharpPINVOKE.ChTriangle_PointTriangleDistance__SWIG_0(ChVectorD.getCPtr(B), ChVectorD.getCPtr(A1), ChVectorD.getCPtr(A2), ChVectorD.getCPtr(A3), SWIGTYPE_p_double.getCPtr(mu), SWIGTYPE_p_double.getCPtr(mv), SWIGTYPE_p_bool.getCPtr(is_into), ChVectorD.getCPtr(Bprojected));
    if (ChronoEngine_csharpPINVOKE.SWIGPendingException.Pending) throw ChronoEngine_csharpPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public double PointTriangleDistance(ChVectorD B, SWIGTYPE_p_double mu, SWIGTYPE_p_double mv, SWIGTYPE_p_bool is_into, ChVectorD Bprojected) {
    double ret = ChronoEngine_csharpPINVOKE.ChTriangle_PointTriangleDistance__SWIG_1(swigCPtr, ChVectorD.getCPtr(B), SWIGTYPE_p_double.getCPtr(mu), SWIGTYPE_p_double.getCPtr(mv), SWIGTYPE_p_bool.getCPtr(is_into), ChVectorD.getCPtr(Bprojected));
    if (ChronoEngine_csharpPINVOKE.SWIGPendingException.Pending) throw ChronoEngine_csharpPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public static double PointLineDistance(ChVectorD p, ChVectorD dA, ChVectorD dB, SWIGTYPE_p_double mu, SWIGTYPE_p_bool is_insegment) {
    double ret = ChronoEngine_csharpPINVOKE.ChTriangle_PointLineDistance(ChVectorD.getCPtr(p), ChVectorD.getCPtr(dA), ChVectorD.getCPtr(dB), SWIGTYPE_p_double.getCPtr(mu), SWIGTYPE_p_bool.getCPtr(is_insegment));
    if (ChronoEngine_csharpPINVOKE.SWIGPendingException.Pending) throw ChronoEngine_csharpPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
