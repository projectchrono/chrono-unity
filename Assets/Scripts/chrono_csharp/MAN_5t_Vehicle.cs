...
public class MAN_5t_Vehicle : ChWheeledVehicle {
  ...
  public MAN_5t_Vehicle(bool fixed_, BrakeType brake_type, ChContactMethod contact_method, CollisionType chassis_collision_type, bool useShaftDrivetrain) : this(vehiclePINVOKE.new_MAN_5t_Vehicle__SWIG_0(fixed_, (int)brake_type, (int)contact_method, (int)chassis_collision_type, useShaftDrivetrain), true) {
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public MAN_5t_Vehicle(bool fixed_, BrakeType brake_type, ChContactMethod contact_method, CollisionType chassis_collision_type) : this(vehiclePINVOKE.new_MAN_5t_Vehicle__SWIG_1(fixed_, (int)brake_type, (int)contact_method, (int)chassis_collision_type), true) {
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public MAN_5t_Vehicle(ChSystem system, bool fixed_, BrakeType brake_type, CollisionType chassis_collision_type, bool useShaftDrivetrain) : this(vehiclePINVOKE.new_MAN_5t_Vehicle__SWIG_3(ChSystem.getCPtr(system), fixed_, (int)brake_type, (int)chassis_collision_type, useShaftDrivetrain), true) {
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public MAN_5t_Vehicle(ChSystem system, bool fixed_, BrakeType brake_type, CollisionType chassis_collision_type) : this(vehiclePINVOKE.new_MAN_5t_Vehicle__SWIG_4(ChSystem.getCPtr(system), fixed_, (int)brake_type, (int)chassis_collision_type), true) {
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
  }
