...
public class MAN_7t_SimpleCVTPowertrain : ChSimpleCVTPowertrain {
  ...
  public MAN_7t_SimpleCVTPowertrain(string name) : this(vehiclePINVOKE.new_MAN_7t_SimpleCVTPowertrain(name), true) {
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public virtual void SetGearRatios(vector_double fwd, SWIGTYPE_p_double rev) {
    vehiclePINVOKE.MAN_7t_SimpleCVTPowertrain_SetGearRatios(swigCPtr, vector_double.getCPtr(fwd), SWIGTYPE_p_double.getCPtr(rev));
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public virtual double GetMaxSpeed() {
    double ret = vehiclePINVOKE.MAN_7t_SimpleCVTPowertrain_GetMaxSpeed(swigCPtr);
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
