...
public class ChFrameD : global::System.IDisposable {
  ...
  public virtual ChVectorD TransformLocalToParent(ChVectorD local) {
  ...
  public virtual ChVectorD TransformPointLocalToParent(ChVectorD local) {
  ...
  public virtual ChVectorD TransformParentToLocal(ChVectorD parent) {
  ...
  public virtual ChVectorD TransformPointParentToLocal(ChVectorD parent) {
  ...
  public virtual void TransformLocalToParent(ChFrameD local, ChFrameD parent) {
  ...
  public virtual void TransformParentToLocal(ChFrameD parent, ChFrameD local) {
  ...
  public virtual ChVectorD TransformDirectionParentToLocal(ChVectorD mdirection) {
  ...
  public virtual ChVectorD TransformDirectionLocalToParent(ChVectorD mdirection) {
