...
public class Generic_SimpleMapPowertrain : ChPowertrain {
  ...
  public override int GetCurrentTransmissionGear() {
    int ret = vehiclePINVOKE.Generic_SimpleMapPowertrain_GetCurrentTransmissionGear(swigCPtr);
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public override void SetDriveMode(ChPowertrain.DriveMode mmode) {
    vehiclePINVOKE.Generic_SimpleMapPowertrain_SetDriveMode(swigCPtr, (int)mmode);
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public void SetSelectedGear(int igear) {
    vehiclePINVOKE.Generic_SimpleMapPowertrain_SetSelectedGear(swigCPtr, igear);
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
  }
