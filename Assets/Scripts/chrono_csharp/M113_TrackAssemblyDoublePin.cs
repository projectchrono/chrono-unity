...
public class M113_TrackAssemblyDoublePin : ChTrackAssemblyDoublePin {
  ...
  public M113_TrackAssemblyDoublePin(VehicleSide side, BrakeType brake_type) : this(vehiclePINVOKE.new_M113_TrackAssemblyDoublePin((int)side, (int)brake_type), true) {
