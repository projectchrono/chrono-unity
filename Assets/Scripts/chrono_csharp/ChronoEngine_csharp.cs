...
public class ChronoEngine_csharp {
  ...
  public static void WriteShapesPovray(ChSystem system, string filename, bool body_info, string delim) {
    ChronoEngine_csharpPINVOKE.WriteShapesPovray__SWIG_0(ChSystem.getCPtr(system), filename, body_info, delim);
    if (ChronoEngine_csharpPINVOKE.SWIGPendingException.Pending) throw ChronoEngine_csharpPINVOKE.SWIGPendingException.Retrieve();
  }

  public static void WriteShapesPovray(ChSystem system, string filename, bool body_info) {
    ChronoEngine_csharpPINVOKE.WriteShapesPovray__SWIG_1(ChSystem.getCPtr(system), filename, body_info);
    if (ChronoEngine_csharpPINVOKE.SWIGPendingException.Pending) throw ChronoEngine_csharpPINVOKE.SWIGPendingException.Retrieve();
  }

  public static void WriteShapesPovray(ChSystem system, string filename) {
    ChronoEngine_csharpPINVOKE.WriteShapesPovray__SWIG_2(ChSystem.getCPtr(system), filename);
    if (ChronoEngine_csharpPINVOKE.SWIGPendingException.Pending) throw ChronoEngine_csharpPINVOKE.SWIGPendingException.Retrieve();
  }
