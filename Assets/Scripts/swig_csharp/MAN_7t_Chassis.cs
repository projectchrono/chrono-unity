...
public class MAN_7t_Chassis : ChRigidChassis {
  ...
  public MAN_7t_Chassis(string name, bool fixed_, ChassisCollisionType chassis_collision_type) : this(vehiclePINVOKE.new_MAN_7t_Chassis__SWIG_0(name, fixed_, (int)chassis_collision_type), true) {
  ...
  public override double GetMass() {
    double ret = vehiclePINVOKE.MAN_7t_Chassis_GetMass(swigCPtr);
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override ChMatrix33D GetInertia() {
    ChMatrix33D ret = new ChMatrix33D(vehiclePINVOKE.MAN_7t_Chassis_GetInertia(swigCPtr), false);
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override ChVectorD GetLocalPosCOM() {
    ChVectorD ret = new ChVectorD(vehiclePINVOKE.MAN_7t_Chassis_GetLocalPosCOM(swigCPtr), false);
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
