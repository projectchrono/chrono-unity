...
public class ChFunctionPosition_line : ChFunctionPosition {
  ...
  public SWIGTYPE_p_std__shared_ptrT_geometry__ChLine_t GetLine() {
    SWIGTYPE_p_std__shared_ptrT_geometry__ChLine_t ret = new SWIGTYPE_p_std__shared_ptrT_geometry__ChLine_t(ChronoEngine_csharpPINVOKE.ChFunctionPosition_line_GetLine(swigCPtr), true);
    if (ChronoEngine_csharpPINVOKE.SWIGPendingException.Pending) throw ChronoEngine_csharpPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void SetLine(SWIGTYPE_p_std__shared_ptrT_geometry__ChLine_t mline) {
    ChronoEngine_csharpPINVOKE.ChFunctionPosition_line_SetLine(swigCPtr, SWIGTYPE_p_std__shared_ptrT_geometry__ChLine_t.getCPtr(mline));
    if (ChronoEngine_csharpPINVOKE.SWIGPendingException.Pending) throw ChronoEngine_csharpPINVOKE.SWIGPendingException.Retrieve();
  }
