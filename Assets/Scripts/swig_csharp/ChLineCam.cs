...
public class ChLineCam : ChLine {
  ...
  public void Set_motion_law(ChFunction mlaw) {
    ChronoEngine_csharpPINVOKE.ChLineCam_Set_motion_law(swigCPtr, ChFunction.getCPtr(mlaw));
    if (ChronoEngine_csharpPINVOKE.SWIGPendingException.Pending) throw ChronoEngine_csharpPINVOKE.SWIGPendingException.Retrieve();
  }

  public ChFunction Get_motion_law() {
    global::System.IntPtr cPtr = ChronoEngine_csharpPINVOKE.ChLineCam_Get_motion_law(swigCPtr);
