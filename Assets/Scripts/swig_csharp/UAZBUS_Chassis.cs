...
public class UAZBUS_Chassis : ChRigidChassis {
  ...
  public UAZBUS_Chassis(string name, bool fixed_, ChassisCollisionType chassis_collision_type) : this(vehiclePINVOKE.new_UAZBUS_Chassis__SWIG_0(name, fixed_, (int)chassis_collision_type), true) {
