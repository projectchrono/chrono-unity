...
public class ChMultiLink : ChSuspension {
  ...
  public override void Initialize(ChBodyAuxRef chassis, ChVectorD location, ChBody tierod_body, int steering_index, double left_ang_vel, double right_ang_vel) {
    vehiclePINVOKE.ChMultiLink_Initialize__SWIG_0(swigCPtr, ChBodyAuxRef.getCPtr(chassis), ChVectorD.getCPtr(location), ChBody.getCPtr(tierod_body), steering_index, left_ang_vel, right_ang_vel);
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public override void Initialize(ChBodyAuxRef chassis, ChVectorD location, ChBody tierod_body, int steering_index, double left_ang_vel) {
    vehiclePINVOKE.ChMultiLink_Initialize__SWIG_1(swigCPtr, ChBodyAuxRef.getCPtr(chassis), ChVectorD.getCPtr(location), ChBody.getCPtr(tierod_body), steering_index, left_ang_vel);
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public override void Initialize(ChBodyAuxRef chassis, ChVectorD location, ChBody tierod_body, int steering_index) {
    vehiclePINVOKE.ChMultiLink_Initialize__SWIG_2(swigCPtr, ChBodyAuxRef.getCPtr(chassis), ChVectorD.getCPtr(location), ChBody.getCPtr(tierod_body), steering_index);
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
  }
