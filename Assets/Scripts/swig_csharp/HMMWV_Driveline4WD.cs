...
public class HMMWV_Driveline4WD : ChShaftsDriveline4WD {
  ...
  public virtual double GetCentralDifferentialRatio() {
    double ret = vehiclePINVOKE.HMMWV_Driveline4WD_GetCentralDifferentialRatio(swigCPtr);
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual double GetFrontDifferentialRatio() {
    double ret = vehiclePINVOKE.HMMWV_Driveline4WD_GetFrontDifferentialRatio(swigCPtr);
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual double GetRearDifferentialRatio() {
    double ret = vehiclePINVOKE.HMMWV_Driveline4WD_GetRearDifferentialRatio(swigCPtr);
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
