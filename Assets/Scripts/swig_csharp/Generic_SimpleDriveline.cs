...
public class Generic_SimpleDriveline : ChDrivelineWV {
  ...
  public override void Initialize(ChChassis chassis, SWIGTYPE_p_ChAxleList axles, vector_int driven_axles) {
    vehiclePINVOKE.Generic_SimpleDriveline_Initialize(swigCPtr, ChChassis.getCPtr(chassis), SWIGTYPE_p_ChAxleList.getCPtr(axles), vector_int.getCPtr(driven_axles));
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public override double GetDriveshaftSpeed() {
    double ret = vehiclePINVOKE.Generic_SimpleDriveline_GetDriveshaftSpeed(swigCPtr);
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
